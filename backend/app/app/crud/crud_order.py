    ...
    def search(
        ...
        *,
        ...
        if is_favorite is not None:
            query = query.join(FavoriteOrder, and_(FavoriteOrder.order_id == Order.id, FavoriteOrder.user_id == current_user.id), isouter=True).filter((FavoriteOrder.id != None) == is_favorite)
